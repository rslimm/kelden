...
class DetailPage extends StatelessWidget {
  ...
  DetailPage(this.programmesDetails);
  ...
  Container _getBackground () {
    return new Container(
      child: new Image.network(programmesDetails.picture,
        fit: BoxFit.cover,
        height: 300.0,
      ),
  ...
  Container _getContent() {
    final _overviewTitle = "Introduction".toUpperCase();
    return new Container(
      child: new ListView(
        padding: new EdgeInsets.fromLTRB(0.0, 72.0, 0.0, 32.0),
        children: <Widget>[
          new ProgrammesSumary(programmesDetails,
            horizontal: false,
          ),
          new Container(
